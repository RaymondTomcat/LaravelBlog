            ...
            <div class="card-body">
                <form class="row g-3" action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="title" value="{{ $post->title }}" id="inputEmail4">
                    </div>
                    <div class="col-md-6">
                        <label for="inputPassword4" class="form-label">عنوان انگلیسی</label>
                        <input type="text" class="form-control" name="slug" value="{{ $post->slug }}" id="inputPassword4">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary"><i class="fa-solid fa-paper-plane"></i> به روز رسانی نوشته</button>
                    </div>
                </form>
            </div>
        </div>
